...
<h3>API Server (Spring boot)</h3>
 ...
 3. Run it as java application (You will get an error, if you havent config th database)
...
Instructions are at the Web UI repository's readme file
[link:](https://github.com/millesinghe/ElectraWeb)

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEyMTE2MDc1MCw0MjkzOTc2NDksLTI4Mz
